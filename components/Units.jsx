...
const [activeRoom, setActiveRoom] = useState(null);
  ...
  return (
    <div className="my-[50px] w-full max-w-[1280px] mx-auto bg-amber-100">
      ...
      {/* ------------------------------- Side Filter && units ------------------------------- */}
      <div className="flex bg-green-700 gap-[16px]">
        {/* ----------------------------side filter----------------- */}
        ...
        {roomOptions.map((room) => (
          <span
            ...
            className={`w-[40px] h-[40px] rounded-sm flex justify-center items-center cursor-pointer
              ${activeRoom === room ? 'bg-black text-white' : 'bg-gray-300 text-black'}`}
          >
            {room}
          </span>
        ))}
    ...
    {/* --------------features------------------- */}
          <div className="w-full mx-auto my-[30px] h-[203px] overflow-y-scroll flex flex-col gap-[16px]">
            ...
            {["Pet-Friendly", "Family Friendly", "Beachfront", "Work-Friendly"].map(
              (type) => (
                <label
                  key={type}
                  className="flex items-center gap-[8px]"
      ...
      {/* -----------------------------------------units-------------------------------------- */}
      <div className="real_estates w-full max-w-[929px] my-[20px] flex gap-[16px] flex-wrap bg-red-300">
            {/* ---------------------------card--------------------------- */}
      
              <div
                className={`estate w-full max-w-[299px] h-[428px] flex flex-col gap-[12px] px-[8px] pt-[8px] pb-[16px] bg-white rounded-md`}
              >
                <div className={`img h-[302px] overflow-hidden relative rounded-md`}>
                ...
                <div className={`price flex justify-between items-center text-[16px] font-semibold`}>
                  <p>Mountainview Villa</p>
                  <p>450,000 Egp</p>
                </div>
                <div className={`estate_cont flex items-center gap-[16px] text-gray-500`}>
                 <p className="text-[12px] flex items-center gap-[8px] pr-[15px] border-r-[1px] border-r-gray-500"> <LuBath className="w-[20px] h-[20px]"/> 3 Baths</p>
                 <p className="text-[12px] flex items-center gap-[8px] pr-[15px] border-r-[1px] border-r-gray-500"> <IoBedOutline className="w-[20px] h-[20px]"/> 6 Beds</p>
                 <p className="text-[12px] flex items-center gap-[8px] "><RxDimensions className="w-[20px] h-[20px]"/> 160 m <sup>2</sup></p>
                </div>
              </div>
  ...
  <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-center">
    ...
    <div>
      <nav className="isolate inline-flex gap-[20px] -space-x-px rounded-md shadow-xs" aria-label="Pagination">
        <a
          href="#"
          className="relative inline-flex items-center rounded-full px-4 py-2 text-sm font-medium text-gray-700 ring-1 ring-gray-300 hover:bg-gray-50"
        >
          Prev
        </a>
        <a
          href="#"
          aria-current="page"
          className="relative z-10 inline-flex items-center rounded-full bg-black px-4 py-2 text-sm font-semibold text-white focus:z-20"
        >
          1
        </a>
        <a
          href="#"
          className="relative inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-gray-300 hover:bg-gray-50 focus:z-20"
        >
          2
        </a>
        <a
          href="#"
          className="relative hidden items-center rounded-full px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-gray-300 hover:bg-gray-50 focus:z-20 md:inline-flex"
        >
          3
        </a>
        <span className="relative inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-gray-300">
          ...
        </span>
        <a
          href="#"
