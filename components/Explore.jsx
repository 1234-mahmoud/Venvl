  ...
  return (
    <div className={`expl my-[100px] flex flex-col justify-center`}>
      ...
      {/* ---------------------------card--------------------------- */}
        ...
        <div
          className={`estate w-full max-w-[413px] h-[519px] flex flex-col gap-[12px] px-[16px] pt-[16px] pb-[32px] bg-white rounded-md`}
        >
          ...
          <div className={`price flex justify-between items-center text-[18px] font-semibold`}>
            <p>Mountainview Villa</p>
            <p>450,000 Egp</p>
          </div>
          <div className={`estate_cont flex items-center gap-[16px] text-gray-500`}>
           <p className="flex items-center gap-[8px] pr-[15px] border-r-[1px] border-r-gray-500"> <LuBath /> 3 Baths</p>
           <p className="flex items-center gap-[8px] pr-[15px] border-r-[1px] border-r-gray-500"> <IoBedOutline /> 6 Beds</p>
            <p className="flex items-center gap-[8px] "><RxDimensions /> 160 m <sup>2</sup></p>
          </div>
        </div>
         {/* ---------------------------card--------------------------- */}
